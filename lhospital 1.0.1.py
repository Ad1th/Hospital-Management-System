...
from tkinter import ttk  # Import ttk for Separator widget
...
def patient_login():
    ...
    login_button = tk.Button(login_frame, text="Login", command=checkpatient_login)
    login_button.pack()
